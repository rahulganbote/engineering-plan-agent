...
Rubric coverage:
    Operationalization & Monitoring (5 pts):
        - Logging & monitoring: 3 pts  ← this file
        - Success/failure criteria: 2 pts  ← SUCCESS_CRITERIA dict below
...
def log_agent_run(
    ...
    Rubric: Operationalization (3 pts for logging) — this is the primary log.
    """
    entry = {
...
# Rubric: Operationalization (2 pts) — pre-defined success criteria
...
FAILURE_MODES: dict[str, dict] = {
    ...
    "injection_blocked": {
        ...
        "mitigation":  "Return friendly error to Streamlit UI, log brd_hash only, pipeline never starts",
