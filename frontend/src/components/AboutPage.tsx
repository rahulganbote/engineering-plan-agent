...
import { ArrowLeft, ExternalLink, Mail, Link2, Cpu, Coins, ShieldAlert, Wrench, CheckCircle } from "lucide-react";
...
const PRINCIPLES: Array<{ headline: string; body: string; anchor: string }> = [
  {
    ...
    body: "Start with a simple, task-focused single agent. Use modular design to build a workflow and think how you will evaluate and how it can be a reliable AI system.",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      <header className="sticky top-0 z-30 bg-background/90 backdrop-blur border-b border-border">
        <div className="max-w-4xl mx-auto px-6 min-h-16 flex items-center justify-between gap-4 py-3">
          <button
            onClick={goHome}
      ...
      <main className="max-w-3xl mx-auto px-6 py-6 space-y-6">
        ...
        <section className="space-y-6 border-b border-border/40 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Enterprise Grade */}
            <div className="p-4 rounded-xl border border-border bg-card/40 space-y-2">
              <h3 className="text-xs font-extrabold uppercase tracking-wider text-purple-500 flex items-center gap-1.5">
                <Cpu size={14} />
                Enterprise Grade
              </h3>
              <p className="text-xs leading-relaxed text-foreground/90 font-medium">
          ...
          <div className="border-l-4 border-primary bg-secondary/35 p-5 rounded-r-xl space-y-3">
            ...
            <p className="text-xs leading-normal text-foreground/90 font-semibold">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-1">
              <div className="space-y-1 bg-background/55 p-3 rounded-lg border border-border/40">
                ...
                <div className="text-xs font-medium space-y-0.5 text-foreground/90">
